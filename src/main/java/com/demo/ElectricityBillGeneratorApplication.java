...
public class ElectricityBillGeneratorApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Consumer c2 = new Consumer("Mahatma Gandhi", "Miyapur", "Hyderabad","domestic");
		consumerRepository.save(c2);
		Consumer c3 = new Consumer("John Cena", "RK colony", "Hyderabad","commercial");
		...
		billRepository.save(new Bill(c1,123,2022,"January",246,"aaa"));
		billRepository.save(new Bill(c2,355,2022,"March",710,"bbb"));
		billRepository.save(new Bill(c3,734,2022,"June",2936,"ccc"));
		billRepository.save(new Bill(c4,454,2021,"Febraury",908,"ddd"));
		billRepository.save(new Bill(c5,555,2021,"May",2220,"eee"));
